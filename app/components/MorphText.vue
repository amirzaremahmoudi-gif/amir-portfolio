...
.morph-word-enter-active, .morph-word-leave-active { transition: opacity 420ms var(--ease-standard), filter 420ms var(--ease-standard), transform 420ms var(--ease-enter); }
...
[lang='fa'] .morph-text { font-weight: 900; line-height: 1.55; }
